...
begin
showmessage('gösterilecek kayýt bulunamadý');
end
else
begin
GroupBox1.Show;
...
if Edit11.Text='' then
begin
  showmessage('lütfen YYYY-MM-DD formatýnda tarih giriniz');
end
else
begin
dbgrid5.Hide;
...
if FDQuery1.RecordCount<=0 then
showmessage('gelir bilgisi bulunamadý');
end;
...
if FDQuery1.RecordCount<=0 then
begin
showmessage('herhangi bir gider bulunamamýþtýr');
end
else
begin
  dbgrid5.Show;
...
begin
  if (Edit1.Text='') or (Edit2.Text='') or (Edit4.Text='') or (Edit5.Text='') or (Edit6.Text='') or (Edit7.Text='') or (Edit12.Text='') or (Edit13.Text='') or (Edit14.Text='')then
      begin
      showmessage('hasta bilgileri boþ býrakýlamaz');
      end
  else
      begin
              if Label4.Caption='' then
                  begin
                showmessage('ürün eklemesi yapýlmamýþ');
                  end
              else
                  begin
                        ...
                        showmessage('SATIÞ ÝÞLEMÝ BAÞARIYLA GERÇEKLEÞTÝ');
                        listbox1.Clear;
                        dblistbox1.Clear;
                        label4.Caption:='';
                        edit10.Text:='';
                        ...
                        begin
                        showmessage('ödeme yöntemi seçilmedi');
                        end;
                  end;
      end;
end;
...
begin
    ...
    begin
        ...
        if Edit8.Text='' then
          begin
          showmessage('lütfen geçerli bir nakit para miktarý giriniz');
          end
          else
          begin
              ...
              showmessage('ödeme iþlemi baþarýyla gerçekleþti');
              listbox3.Clear;
              dblistbox2.Clear;
              label23.Caption:='';
              edit8.Text:='';
        ...
        begin
        showmessage('ödeme yöntemi seçilmemiþ');
        end;
    end;
end;
...
procedure TForm1.FormCreate(Sender: TObject);   //form açýlýþý
begin
GroupBox1.Hide;
GroupBox2.Hide;
GroupBox4.Hide;
